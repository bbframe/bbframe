<?php /* Smarty version 2.6.26, created on 2010-11-03 12:57:49
         compiled from addarticles.html */ ?>
...
/articles/add/" method="post" name='addArticle'>
	<input type='text' name="articleName" value="" size='100'><br /><br />
	<textarea name='articleDescription' id='articleMess' row='5'>example text</textarea>
	
	<?php echo ' 
				<script type="text/javascript">
			//<![CDATA[
 
			CKEDITOR.replace( \'articleMess\',
    			{
        		toolbar :
        		[
            	[\'Styles\', \'Format\'],
